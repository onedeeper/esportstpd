...
for (i in 0:99){
  ...
  # player 0
  RQA.p0 = crqa(ts1 = Am0, ts2 = Am0, delay = delay, embed = embeddim, rescale = 1, radius = radius, 
  ...
  # player 1
  RQA.p1 = crqa(ts1 = Am1, ts2 = Am1, delay = delay, embed = embeddim, rescale = 1, radius = radius, 
                normalize = 0, mindiagline = 2, minvertline = 2, tw = 0, whiteline = FALSE, recpt = FALSE)
  ...
  # player 2
  RQA.p2 = crqa(ts1 = Am2, ts2 = Am2, delay = delay, embed = embeddim, rescale = 1, radius = radius, 
                normalize = 0, mindiagline = 2, minvertline = 2, tw = 0, whiteline = FALSE, recpt = FALSE)
  ...
  # player 3
  RQA.p3 = crqa(ts1 = Am3, ts2 = Am3, delay = delay, embed = embeddim, rescale = 1, radius = radius, 
                normalize = 0, mindiagline = 2, minvertline = 2, tw = 0, whiteline = FALSE, recpt = FALSE)
  ...
  # player 4
  RQA.p4 = crqa(ts1 = Am4, ts2 = Am4, delay = delay, embed = embeddim, rescale = 1, radius = radius, 
                normalize = 0, mindiagline = 2, minvertline = 2, tw = 0, whiteline = FALSE, recpt = FALSE)
