---
title: "Surrogate CRQA GSR Amateurs"
...
setwd('C:/Users/jette/Documents/Uni/Tilburg/Semester2/Complex Systems/Project CS/surrogates/amateur_surrogates/GSR')

# get the auto-RR for all the surrogates for each player 
# store RRs 

# fix the parameters as they were estimated from the actual data on Am's gsr
delay = 36.4
embeddim = 9.8
radius = 0.4
...
for (i in 0:99){
  ...
  file <- sprintf("amateur_surrogate_gsr%i.csv", i)
  Am.surr.gsr <- read.csv(file)

  # get the single players 
  Am0 <- Am.surr.gsr$player_0
  Am1 <- Am.surr.gsr$player_1
  Am2 <- Am.surr.gsr$player_2
  Am3 <- Am.surr.gsr$player_3
  Am4 <- Am.surr.gsr$player_4
  
  all_players <- Am.surr.gsr
...
```{r}
# randomly choose gsr0 surrogate data 
setwd('C:/Users/jette/Documents/Uni/Tilburg/Semester2/Complex Systems/Project CS/surrogates/amateur_surrogates/GSR')
Am.surr.gsr <- read.csv("amateur_surrogate_gsr0.csv")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 0 & Am 3 Diagonal Recurrence Profile")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 0 & Am 4 Diagonal Recurrence Profile")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 1 & Am 4 Diagonal Recurrence Profile")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 2 & Am 3 Diagonal Recurrence Profile")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 2 & Am 4 Diagonal Recurrence Profile")
...
plot(-windowsize:windowsize, profile, type = "l", lwd = 5, xlab = "Lags around Line of Synchrony", ylab = "%REC", main = "GSR Am 3 & Am 4 Diagonal Recurrence Profile")
